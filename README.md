...
you can add a passphrase, require two keys to unlock, or just let the system handle it. (as simple as it gets)
...
Just a really old project i made when i was 15, thought itd be cool 2 have this up somewhere.
